...
##### OK(get a wsdl generated by wsgen from server)

``` sh
./mvnw clean test -pl client -Dtest=axis2.jaxws.soap12.client.ClientTest#testSoap12 \
  -Dsoap12.wsdl.location=/path/to/axis2-jaxws-soap12-demo/server/target/generated-sources/wsdl/HelloWorldSoap12.wsdl 
```

Please change the address in HelloWorldSoap12.wsdl
...
``` xml
<soap12:address location="http://localhost:8080/axis2-jaxws-soap12-demo-server/services/HelloWorldSoap12"/>
```

##### NG(get a wsdl generated by axis2)
